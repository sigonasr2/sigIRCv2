...
public class sigIRC{
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Could not connect to Twitch servers! Will try again in 1 second.");
		}
	}
	...
	public static void InitializeIRCConnection(final String server,final String nickname,final String channel,final String oauth) throws UnknownHostException {
		Socket socket;
		try {
